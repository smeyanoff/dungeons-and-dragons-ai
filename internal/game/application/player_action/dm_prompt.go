...
⚠️ ПРОВЕРКИ: НЕ проси броски кубиков — система сама обработает. Просто описывай художественно.
...
📚 ИСТОРИЯ: Используй RAG для согласованности сюжета.
...
✅ ОБЯЗАТЕЛЬНО: После провала проверки — автоматически опиши последствия и продолжи повествование.`, gameContext, playerMessage, combatInstruction, lengthInstruction, styleInstruction)
}
