...
func (t *UseSpellTool) Description() string {
	return `Использовать заклинание персонажем во время боя или вне боя. Используй этот инструмент, когда игрок описывает использование заклинания или когда описываешь использование заклинания персонажем.
Инструмент автоматически:
- Проверит, известно ли заклинание персонажу
...
- Применит эффекты заклинания

Параметры:
- spell_name (обязательно): Имя заклинания для использования (например, "Огненный снаряд", "Лечение ран")
...
- use_spell(spell_name="Свет") - использовать утилитарное заклинание

Используй этот инструмент когда игрок явно использует заклинание или когда описываешь автоматическое использование заклинания (например, враг использует заклинание или персонаж автоматически лечится).`
}
