...
func (t *GenerateImageTool) Description() string {
	return `Генерирует изображение через AI по текстовому описанию. Используй этот инструмент когда хочешь нарисовать или визуализировать что-то в игре:
...
Примеры использования: "нарисуй древний замок в горах", "сгенерируй изображение эльфийского лучника", "покажи магический меч".
